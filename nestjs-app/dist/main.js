...
const files_module_1 = __webpack_require__(28);
...
const badgeCreator_1 = __webpack_require__(16);
let UsersService = class UsersService {
    ...
    async findById(id) {
        ...
        const { pdf } = user, rest = __rest(user, ["pdf"]);
        return rest;
    }
    ...
    async createBadge(email, guardId) {
        const user = await this.findByEmail(email);
        const guar = await this.findById(guardId);
        try {
            const userBadge = await (0, badgeCreator_1.badgeCreator)(user, guar);
            if (userBadge) {
...
], UserEntity.prototype, "pdf", void 0);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.badgeCreator = void 0;
const PDFDocument = __webpack_require__(17);
const path_1 = __webpack_require__(18);
const badgeCreator = async (user, guar) => {
    const filePath = user.image
        ? (0, path_1.join)('./uploads/', user.image)
    ...
    const ret = await new Promise((resolve, reject) => {
        try {
            ...
            doc
                ...
                .font('Times-Bold', 7)
                .text(`${guar.lastName} ${guar.firstName}`, 10, 190);
            doc.end();
        }
        catch (err) {
...
exports.badgeCreator = badgeCreator;
...
const swagger_1 = __webpack_require__(5);
const jwt_guard_1 = __webpack_require__(23);
const userId_decorator_1 = __webpack_require__(25);
const get_badge_dto_1 = __webpack_require__(26);
...
__decorate([
    ...
    __param(0, (0, userId_decorator_1.UserId)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_c = typeof get_badge_dto_1.GetBadgeDto !== "undefined" && get_badge_dto_1.GetBadgeDto) === "function" ? _c : Object, Number]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "createBadge", null);
__decorate([
    (0, common_1.Get)('/badge/:userId'),
    (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard),
    ...
    __metadata("design:returntype", Promise)
], UsersController.prototype, "getBadge", null);
...
__decorate([
    ...
    __metadata("design:type", String)
], GetBadgeDto.prototype, "email", void 0);
exports.GetBadgeDto = GetBadgeDto;
...
const typeorm_1 = __webpack_require__(9);
const common_1 = __webpack_require__(8);
const files_service_1 = __webpack_require__(29);
...
let FilesService = class FilesService {
    ...
    async remove(path) {
        const filePath = (0, path_1.join)(__dirname, '..', path);
...
const storage_1 = __webpack_require__(34);
const swagger_1 = __webpack_require__(5);
const jwt_guard_1 = __webpack_require__(23);
const userId_decorator_1 = __webpack_require__(25);
...
__decorate([
    ...
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file', {
        storage: storage_1.filesStorage,
    })),
    ...
    __param(1, (0, userId_decorator_1.UserId)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_c = typeof Express !== "undefined" && (_b = Express.Multer) !== void 0 && _b.File) === "function" ? _c : Object, Number]),
...
const multer_1 = __webpack_require__(35);
...
exports.AppError = {
    USER_EXIST: 'User with this email address is already registered.',
    USER_NOT_EXIST: 'User with such data was not found.',
    USER_DONT_HAVE_ACCESS: "You don't have access.",
};
...
const auth_service_1 = __webpack_require__(37);
const swagger_1 = __webpack_require__(5);
const login_user_dto_1 = __webpack_require__(41);
const create_user_dto_1 = __webpack_require__(22);
const local_guard_1 = __webpack_require__(42);
...
let LocalStrategy = class LocalStrategy extends (0, passport_1.PassportStrategy)(passport_local_1.Strategy) {
    ...
    async validate(email, password) {
        ...
        if (!user) {
            throw new common_1.UnauthorizedException(errors_1.AppError.USER_NOT_EXIST);
        }
        return user;
    }
};
...
let JwtStrategy = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy) {
    ...
    async validate(payload) {
        ...
        if (!user) {
            throw new common_1.UnauthorizedException(errors_1.AppError.USER_DONT_HAVE_ACCESS);
        }
        return user;
    }
};
